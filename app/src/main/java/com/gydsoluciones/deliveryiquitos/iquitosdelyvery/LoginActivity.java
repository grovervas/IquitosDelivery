        ...
        if (cancel) {
            ...
            StringRequest request = new StringRequest(Request.Method.POST, urlLogin, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    Log.i("LOG_VOLLEY", "Acceso correcto");
                    try {
                        JSONObject jsonDatos = new JSONObject(response);
                        Intent intent = new Intent(LoginActivity.this, MainActivity.class);
                        intent.putExtra("token",jsonDatos.getString("token"));
                        intent.putExtra("id_usuario",jsonDatos.getString("id_usuario"));
                        showProgress(false);
                ...
                protected Map<String,String>getParams(){
                    ...
                    params.put("clave",mPasswordView.getText().toString());
                    return params;
                }
                @Override
